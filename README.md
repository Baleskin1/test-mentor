...
```console
python3 solution_v2.py
```
Для вывода в файл можно использовать, например:
```console
python3 solution_v2.py > result.txt
```
...
2. Чрезмерное потребление системных ресурсов:
   - считывание файлов в память целиком - readlines заменил на последовательное чтение, так что, вроде, готово
   - считывание файла более 1 раза - вроде как, исправлено, теперь каждый файл читается не более одного раза
