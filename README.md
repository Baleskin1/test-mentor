...
## Важное замечание
На 98-й строке *solution.py* находится флаг. Если закомментировать эту строку, задача будет выполнятся в соответствии с заданием. Иначе - в соответствии с референсным выводом.
